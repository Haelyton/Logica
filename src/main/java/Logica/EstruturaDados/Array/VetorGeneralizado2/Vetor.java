package Logica.EstruturaDados.Array.VetorGeneralizado2;
...
public class Vetor {
    ...
    public Vetor(final int capacidade) {
        this.professor = new Object[capacidade];
        this.tamanho = 0;
    }
...
//    }
    ...
    public void adicionar(Object elemento) throws IllegalAccessException {
        aumentaCapacidade();
    ...
    public Object buscarElemento(int posicao) throws IllegalAccessException {
    ...
    private void aumentaCapacidade() {
        if (tamanho == professor.length) {
            Object[] novoArray = new Object[this.professor.length * 2];
            for (int i = 0; i < tamanho; i++) {
